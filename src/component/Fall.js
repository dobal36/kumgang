...
function Fall() {
  ...
  const [selectedMenu, setSelectedMenu] = useState(navi[3].link);
        ...
        <div className={styles.contentMain}>
          <div className={styles.mainContent}>
            ...
            <div className={styles.subContent}>
              ...
              <p>
                <h2>
                  기암절벽과 단풍이 어우러져 한곡의 멋진 풍악을 울리는 듯{" "}
                </h2>
              </p>
              <p>
                사방팔방 어디를 둘러보아도 산이 붉게 불타느라 정신이 없습니다.
              </p>
              <p>
                바위와 소나무 그리고 단풍나무가 조화롭게 어우러져 금강산의
                색채미를 대변합니다.
              </p>
              <p>풍악산은 산이 붉게 불탄다 하여 풍악산이라 불립니다.</p>
              <YouTube
                videoId={"vHGqY1hVhFU"} // 동영상 주소
                opts={{
                  width: "100%",
                  height: "50%",
                  playerVars: {
                    ...
                    loop: 1, // 반복 재생
                    playlist: "vHGqY1hVhFU", // 반복 재생으로 재생할 플레이 리스트
                  },
                }}
                onReady={(e) => {
                  e.target.mute(); // 소리 끔
